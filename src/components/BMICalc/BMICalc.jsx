      ...
      {(
        <div>
            ...
            <div>
                ...
                <p>
                    Target Weight Result to Achieve the Target BMI: {result_Target_Weight}
                </p>
                <p>
                    Target Weight Loss Needed to Achieve the Target BMI: {weight_pounds - (result_Target_Weight)}
                </p>
            </div>
